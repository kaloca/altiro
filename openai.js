...
const runCompletion = async (question, context, msg_body) => await openai.createChatCompletion({
        model: "gpt-3.5-turbo",
        messages: [
          {
            role: "system",
            content: "You are Altiro, a friendly bot that helps with personal and professional questions.\
